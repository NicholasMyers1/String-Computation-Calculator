...
public class Main {
	public static void main(String args[]) {
		...
		System.out.println("Static methods from StringMath can be used to set StringNumbers:");
		System.out.println("\tA couple of examples: (z=25)"); z.set(25);
		z = StringMath.add(z,z);								System.out.println("\tz = StringMath.add(z,z):\t\t\t\t"+z.get());
		z = new StringNumber(StringMath.add(z.get(),"5","1"));	System.out.println("\tz = new StringNumber(StringMath.add(z.get(),\"5\",\"1\")):\t"+z.get());
		...
		System.out.println("\tExamples: (public static String function( String... x ) | public static StringNumber function( StringNumber... x ) | @SafeVarargs public static StringNumber function( List<Object>...x )");
		...
		g.add("44");
		System.out.println("\tf="+StringMath.add(f));
		System.out.println("\tg="+StringMath.add(g));
		System.out.println( "\t(StringMath.add( \"1\" ) = " + StringMath.add( "1" ));
		System.out.println( "\t(StringMath.add( new StringNumber(\"1\") ) = " + StringMath.add( new StringNumber("1") ));
		System.out.println( "\t(StringMath.add( new LinkedList<>(Arrays.asList(\"1\")) ) = " + StringMath.add( new LinkedList<>(Arrays.asList("1")) ));
		System.out.println( "\t(StringMath.sub( \"1\" ) = " + StringMath.sub( "1" ));
		System.out.println( "\t(StringMath.sub( new StringNumber(\"1\") ) = " + StringMath.sub( new StringNumber("1") ));
		System.out.println( "\t(StringMath.sub( new LinkedList<>(Arrays.asList(\"1\")) ) = " + StringMath.sub( new LinkedList<>(Arrays.asList("1")) ));
		System.out.println( "\t(StringMath.mult( \"1\" ) = " + StringMath.mult( "1" ));
		System.out.println( "\t(StringMath.mult( new StringNumber(\"1\") ) = " + StringMath.mult( new StringNumber("1") ));
		System.out.println( "\t(StringMath.mult( new LinkedList<>(Arrays.asList(\"1\")) ) = " + StringMath.mult( new LinkedList<>(Arrays.asList("1")) ));
		System.out.println( "\t(one of objects StringMath.add( f ) = " + StringMath.add( "0" ));
		System.out.println( "\t(one of objects StringMath.add( f ) = " + StringMath.add( "0" ));
		System.out.println( "\t(one of objects StringMath.add( f ) = " + StringMath.add( f ));
		System.out.println( "\t(Two lists of objects StringMath.add( f,f ) = " + StringMath.add( f, f ));
		System.out.println( "\tStringMath.add( new ArrayList<>(Arrays.asList(true+\"22\"+.222+false)) = " + StringMath.add( new ArrayList<>(Arrays.asList(true,"22",.222, false)) ));
		System.out.println( "\tStringMath.add( new LinkedList<>(Arrays.asList(g, g, \"1\") = " + StringMath.add( new LinkedList<>(Arrays.asList(g,g,"1")) ));
		System.out.println( "\tStringMath.add( new LinkedList<>(Arrays.asList(g, g, \"1\") = " + StringMath.add( f, new LinkedList<>(Arrays.asList(g,g,"1")) ));
		System.out.println( "\tStringMath.add( new StringNumber(3 + g + g) = " + StringMath.add( new StringNumber("3"), g, g));
